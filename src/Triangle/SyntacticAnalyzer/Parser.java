...
import Triangle.AbstractSyntaxTrees.RunCommand;
import Triangle.AbstractSyntaxTrees.PutCommand;
...
*/
      case Token.RUN:{
        ...
        Command cAST = parseSingleCommand();
        finish(commandPos);
        commandAST = new RunCommand(ilAST,cAST,commandPos);
      }
      break;
      ...
      case Token.PUT:{
        ...
        Command c2AST = parseSingleCommand();
        finish(commandPos);
        commandAST = new PutCommand(vAST,c1AST, tAST, c2AST,commandPos);
      }
      break;
      /*
      case Token.FOR:{
